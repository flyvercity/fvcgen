...
import pytest
from fvcgen.config import Config, BasePoint, Defaults, CoordinateErrors, CoordinateError
                ...
                'objects': [
                    {
                        'id': 'UAS-001',
                        'waypoints': [
                            {'east': 0.0, 'north': 0.0, 'up': 120.0},
                            {'east': 1000.0, 'north': 0.0, 'up': 120.0}
                        ]
                    }
                ]
            }
